...
<div class="flex flex-col h-4/4 h-full w-screen p-5 items-center bg-white">
    <p class="text-4xl font-bold text-gray-900 dark:text-white p-1">Kay Dédé</p>
        <img src="/images/plat1.jpg" alt="" class="w-2/6">
        <p class="text-3xl font-medium text-gray-900 dark:text-white p-5">Le restaurant Kay Dédé a ouvert ses portes en 2022.
...
<div class="flex w-screen p-10 items-center bg-white m-11">
 ...
 <p class="text-3xl font-medium text-gray-900 dark:text-white p-10">
